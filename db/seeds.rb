...
Message.create(user: juan_user, channel: ruby, content: "ruby message")
Message.create(user: test_user, channel: general, content: "third message")
Message.create(user: test_user, channel: javascript, content: "javascript message")
Message.create(user: juan_user, channel: python, content: "python message")
Message.create(user: juan_user, channel: general, content: "forth message")
